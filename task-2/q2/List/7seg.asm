...
; 0000 0030 char bcd_encode(int num){

	.CSEG
_bcd_encode:
; 0000 0031     switch (num){
;	num -> Y+0
	LD   R30,Y
	LDD  R31,Y+1
; 0000 0032      case 0:    return 0b0111111;
	SBIW R30,0
	BRNE _0x6
	LDI  R30,LOW(63)
	RJMP _0x2000001
; 0000 0033      case 1:    return 0b0000110;
_0x6:
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	...
	LDI  R30,LOW(6)
	RJMP _0x2000001
; 0000 0034      case 2:    return 0b1011011;
_0x7:
	CPI  R30,LOW(0x2)
	LDI  R26,HIGH(0x2)
	CPC  R31,R26
	...
	LDI  R30,LOW(91)
	RJMP _0x2000001
; 0000 0035      case 3:    return 0b1001111;
_0x8:
	CPI  R30,LOW(0x3)
	LDI  R26,HIGH(0x3)
	CPC  R31,R26
	...
	LDI  R30,LOW(79)
	RJMP _0x2000001
; 0000 0036      case 4:    return 0b1100110;
_0x9:
	CPI  R30,LOW(0x4)
	LDI  R26,HIGH(0x4)
	CPC  R31,R26
	...
	LDI  R30,LOW(102)
	RJMP _0x2000001
; 0000 0037      case 5:    return 0b1101101;
_0xA:
	CPI  R30,LOW(0x5)
	LDI  R26,HIGH(0x5)
	CPC  R31,R26
	...
	LDI  R30,LOW(109)
	RJMP _0x2000001
; 0000 0038      case 6:    return 0b1111101;
_0xB:
	CPI  R30,LOW(0x6)
	LDI  R26,HIGH(0x6)
	CPC  R31,R26
	...
	LDI  R30,LOW(125)
	RJMP _0x2000001
; 0000 0039      case 7:    return 0b0000111;
_0xC:
	CPI  R30,LOW(0x7)
	LDI  R26,HIGH(0x7)
	CPC  R31,R26
	...
	LDI  R30,LOW(7)
	RJMP _0x2000001
; 0000 003A      case 8:    return 0b1111111;
_0xD:
	CPI  R30,LOW(0x8)
	LDI  R26,HIGH(0x8)
	CPC  R31,R26
	...
	LDI  R30,LOW(127)
	RJMP _0x2000001
; 0000 003B      case 9:    return 0b1101111;
_0xE:
	CPI  R30,LOW(0x9)
	LDI  R26,HIGH(0x9)
	CPC  R31,R26
...
_0x10:
	...
	ANDI R30,LOW(0xF)
	OUT  0x15,R30
; 0000 0044     PORTD = bcd_encode(timer_array[active_port]);
	LDS  R30,_active_port_G000
...
; 0000 0049 void timer1_tick_procedure(){
_timer1_tick_procedure:
; 0000 004A     int i,digit=timer;
; 0000 004B     timer++;
	CALL __SAVELOCR4
;	i -> R16,R17
;	digit -> R18,R19
